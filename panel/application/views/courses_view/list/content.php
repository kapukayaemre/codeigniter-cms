<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            Eğitim Listesi
            <a href="<?php echo base_url("courses/new_form"); ?>" class="btn btn-outline btn-primary btn-sm pull-right"><i
            ...
            <?php if (empty($items)) { ?>
                <div class="alert alert-info text-center">
                    ...
                    <p>Burada herhangi bir veri bulunmamaktadır. Eklemek için lütfen <a
                            href="<?php echo base_url("courses/new_form"); ?>"><strong>tıklayınız.</strong></a></p>
                </div>
            <?php } else { ?>
                            ...
                            <?php foreach ($items as $item) { ?>
                                <tr id="ord-<?php echo $item->id; ?>">
                                    ...
                                    <td style="width: 200px" class="text-center">
                                        ...
                                        <a href="<?php echo base_url("courses/update_form/$item->id"); ?>"
